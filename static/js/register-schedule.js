var Script = function() {
  ...
  jQuery(function(){
    ...
    // datetime picker
    jQuery('#datetimepicker,#mordal-startdate').datetimepicker();

    // datetime picker start
    jQuery('#date_timepicker_start,#mordal-enddate').datetimepicker({
      format:'Y/m/d H:i',
      lang:'ja',
      onShow:function( ct ){
       this.setOptions({
    ...
    // datetime picker start
    jQuery('#mordal-startdate').datetimepicker({
      format:'Y/m/d H:i',
      lang:'ja',
      onShow:function( ct ){
       this.setOptions({
        maxDateTime:jQuery('#mordal-enddate').val()?jQuery('#mordal-enddate').val():false
       })
      },
      timepicker:true
     });
     ...
     // datetime picker end
     jQuery('#mordal-enddate').datetimepicker({
      format:'Y/m/d H:i',
      lang:'ja',
      onShow:function( ct ){
       this.setOptions({
        minDateTime:jQuery('#mordal-startdate').val()?jQuery('#mordal-startdate').val():false
       })
      },
      timepicker:true
     });
